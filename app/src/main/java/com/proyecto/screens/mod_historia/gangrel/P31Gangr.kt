...
fun P31Gangr(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
        ...
        MaterialTheme(
            ...
            content = {
                ...
                Scaffold (
                    ...
                    //Menu con texto
                    BodyP31Gangr(navController, viewModel, sharedViewModel)
                }
            }
        )
    }
...
@Composable
fun BodyP31Gangr(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
    ...
    LazyColumn(
        ...
        item {
            Text(text = stringResource(R.string.p31TextG),
                color = Blanco
            )
            ...
            DefaultButton(onClick = {
                navController.navigate(route = Screens.P4Gangr.route) // P4
            },
                text = ("Continuar")
            )
