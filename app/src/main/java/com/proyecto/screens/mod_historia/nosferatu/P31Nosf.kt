...
fun P31Nosf(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
        ...
        MaterialTheme(
            ...
            content = {
                ...
                Scaffold (
                    ...
                    //Menu con texto
                    BodyP31Nosf(navController, viewModel, sharedViewModel)
                }
            }
        )
    }
...
@Composable
fun BodyP31Nosf(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
    ...
    LazyColumn(
        ...
        item {
            ...
            Text(text = stringResource(R.string.p31TextN),
                color = Color.White)

            Spacer(modifier = Modifier.height(25.dp))
            //Eleccion 1
            DefaultButton(onClick = {
                navController.navigate(route = Screens.P32Nosf.route) // 3.2
            },
                text = (stringResource(R.string.p31E1N))
            )

            Spacer(modifier = Modifier.height(15.dp))
            //Eleccion 2
            DefaultButton(onClick = {
                navController.navigate(route = Screens.P42Nosf.route) // 4.2
            },
                text = (stringResource(R.string.p31E2N))
            )
