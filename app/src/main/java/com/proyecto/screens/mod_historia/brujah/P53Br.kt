...
fun P53Br(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
        ...
        MaterialTheme(
            ...
            content = {
                ...
                Scaffold (
                    ...
                    //Menu con texto
                    BodyP53Br(navController, viewModel, sharedViewModel)
                }
            }
        )
    }
...
@Composable
fun BodyP53Br(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
    val state = viewModel.state
    ...
    LazyColumn(
        ...
        item {
            Text(text = stringResource(R.string.p53TextB),
                color = Blanco
            )
