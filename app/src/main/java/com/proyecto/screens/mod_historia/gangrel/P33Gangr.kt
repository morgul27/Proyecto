...
fun P33Gangr(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
        ...
        MaterialTheme(
            ...
            content = {
                ...
                Scaffold (
                    ...
                    //Menu con texto
                    BodyP33Gangr(navController, viewModel, sharedViewModel)
                }
            }
        )
    }
...
@Composable
fun BodyP33Gangr(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
    ...
    LazyColumn(
        ...
        item {
            Text(text = stringResource(R.string.p33TextG),
                color = Blanco
            )
