...
fun P32Nosf(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
        ...
        MaterialTheme(
            ...
            content = {
                ...
                Scaffold (
                    ...
                    //Menu con texto
                    BodyP32Nosf(navController, viewModel, sharedViewModel)
                }
            }
        )
    }
...
@Composable
fun BodyP32Nosf(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
    ...
    LazyColumn(
        ...
        item {
            ...
            Text(stringResource(R.string.p32TextN),
                color = Color.White)
            ...
            DefaultButton(onClick = {
                ...
                navController.navigate(route = Screens.P41Nosf.route) // 4.1
            },
                text = (stringResource(R.string.p32E1N))
            )
            ...
            DefaultButton(onClick = {
                ...
                text = (stringResource(R.string.p32E2N))
            )
