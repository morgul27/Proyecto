...
fun P52Gangr(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
        ...
        MaterialTheme(
            ...
            content = {
                ...
                Scaffold (
                    ...
                    //Menu con texto
                    BodyP52Gangr(navController, viewModel, sharedViewModel)
                }
            }
        )
    }
...
@Composable
fun BodyP52Gangr(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
    ...
    LazyColumn(
        ...
        item {
            ...
            Text(stringResource(R.string.p52TextG),
                color = Color.White)
            ...
            DefaultButton(onClick = {
                navController.navigate(route = Screens.P7Gangr.route) // 7
            },
                text = (stringResource(R.string.p52E1G))
            )
            ...
            //Eleccion 2
            DefaultButton(onClick = {
                navController.navigate(route = Screens.P8Gangr.route) // 8
            },
                text = (stringResource(R.string.p52E2G))
            )
