...
fun P61Gangr(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
        ...
        MaterialTheme(
            ...
            content = {
                ...
                Scaffold (
                    ...
                    //Menu con texto
                    BodyP61Gangr(navController, viewModel, sharedViewModel)
                }
            }
        )
    }
...
@Composable
fun BodyP61Gangr(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
    val state = viewModel.state
    ...
    LazyColumn(
        ...
        item {
            Text(text = stringResource(R.string.p61TextG),
                color = Blanco
            )
            ...
            DefaultButton(onClick = {
                navController.navigate(route = Screens.P7Gangr.route) //Pantalla 7
            },
                text = ("Continuar")
            )
