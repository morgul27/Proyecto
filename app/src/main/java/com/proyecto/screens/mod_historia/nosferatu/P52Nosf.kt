...
fun P52Nosf(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
            ...
            content = {
                ...
                Scaffold (
                    ...
                    if (viewModel.showSecondMenuHist.value == true) {
                        //Menu de dados
                        MenuVerTirada2P52Nosf(navController, viewModel, viewModel.nDados, viewModel.dificult[viewModel.movDif])
                    } else {
                        //Menu con texto
                        BodyP52Nosf(navController, viewModel, sharedViewModel)
                    }
                }
            }
        )
...
@Composable
fun BodyP52Nosf(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
    val state = viewModel.state
    ...
    LazyColumn(
        ...
        item {
            Text(text = stringResource(R.string.p52TextN),
                color = Blanco
            )
            ...
            DefaultButton(onClick = {
                ...
                text = ("Tirada de Manipulacion dificil")
            )
...
//Menu bueno
@Composable
fun MenuVerTirada2P52Nosf(navController: NavController, viewModel: MPViewModel, nUsuario : Int, nNecesario: Int) {
