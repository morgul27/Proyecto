...
fun P41Br(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
        ...
        MaterialTheme(
            ...
            content = {
                ...
                Scaffold (
                    ...
                    //Menu con texto
                    BodyP41Br(navController, viewModel, sharedViewModel)
                }
            }
        )
    }
...
@Composable
fun BodyP41Br(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
    ...
    LazyColumn(
        ...
        item {
            ...
            Text(stringResource(R.string.p41TextB),
                color = Color.White)
            ...
            DefaultButton(onClick = {
                ...
                text = (stringResource(R.string.p41E1B))
            )

            //Eleccion 2
            DefaultButton(onClick = {
                navController.navigate(route = Screens.P53Br.route) // 5.3
            },
                text = (stringResource(R.string.p41E2B))
            )
