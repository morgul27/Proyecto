...
fun P8Gangr(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
            ...
            content = {
                ...
                Scaffold (
                    ...
                    if (viewModel.showSecondMenuHist.value == true) {
                        //Menu de dados
                        MenuVerTirada2P8Gangr(navController, viewModel, viewModel.nDados, viewModel.dificult[viewModel.movDif])
                    } else {
                        //Menu con texto
                        BodyP8Gangr(navController, viewModel, sharedViewModel)
                    }
                }
            }
        )
...
@Composable
fun BodyP8Gangr(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
    val state = viewModel.state
    ...
    LazyColumn(
        ...
        item {
            Text(text = stringResource(R.string.p8TextG),
                color = Blanco
            )
...
//Menu bueno
@Composable
fun MenuVerTirada2P8Gangr(navController: NavController, viewModel: MPViewModel, nUsuario : Int, nNecesario: Int) {
    val direccion = { navController.navigate(route = Screens.P81Gangr.route) } //rellenar esto 8.1
    val direccion2 = { navController.navigate(route = Screens.P82Gangr.route) } //rellenar esto 8.2
