...
fun P42Nosf(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
        ...
        MaterialTheme(
            ...
            content = {
                ...
                Scaffold (
                    ...
                    //Menu con texto
                    BodyP42Nosf(navController, viewModel, sharedViewModel)
                }
            }
        )
    }
...
@Composable
fun BodyP42Nosf(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
    ...
    LazyColumn(
        ...
        item {
            ...
            Text(stringResource(R.string.p42TextN),
                color = Color.White)
            ...
            DefaultButton(onClick = {
                ...
                navController.navigate(route = Screens.P52Nosf.route) // 5.2
            },
                text = ("Continuar")
            )
