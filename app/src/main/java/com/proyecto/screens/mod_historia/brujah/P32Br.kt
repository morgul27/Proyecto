...
fun P32Br(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
        ...
        MaterialTheme(
            ...
            content = {
                ...
                Scaffold (
                    ...
                    //Menu con texto
                    BodyP32Br(navController, viewModel, sharedViewModel)
                }
            }
        )
    }
...
@Composable
fun BodyP32Br(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
    ...
    LazyColumn(
        ...
        item {
            Text(text = stringResource(R.string.p32TextB),
                color = Blanco
            )
            ...
            DefaultButton(onClick = {
                navController.navigate(route = Screens.P42Br.route)
            },
                text = ("Continuar")
            )
