...
fun P82Gangr(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
        ...
        MaterialTheme(
            ...
            content = {
                ...
                Scaffold (
                    ...
                    //Menu con texto
                    BodyP82Gangr(navController, viewModel, sharedViewModel)
                }
            }
        )
    }
...
@Composable
fun BodyP82Gangr(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
    ...
    LazyColumn(
        ...
        item {
            Text(text = stringResource(R.string.p82TextG),
                color = Blanco
            )
