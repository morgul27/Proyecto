...
fun P62Gangr(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
        ...
        MaterialTheme(
            ...
            content = {
                ...
                Scaffold (
                    ...
                    //Menu con texto
                    BodyP62Gangr(navController, viewModel, sharedViewModel)
                }
            }
        )
    }
...
@Composable
fun BodyP62Gangr(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
    ...
    LazyColumn(
        ...
        item {
            Text(text = stringResource(R.string.p62TextG),
                color = Blanco
            )
            ...
            DefaultButton(onClick = {
                navController.navigate(route = Screens.P8Gangr.route) //Pantalla 8
            },
                text = ("Continuar")
            )
