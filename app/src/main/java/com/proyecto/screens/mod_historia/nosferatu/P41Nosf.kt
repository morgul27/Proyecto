...
fun P41Nosf(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
        ...
        MaterialTheme(
            ...
            content = {
                ...
                Scaffold (
                    ...
                    //Menu con texto
                    BodyP41Nosf(navController, viewModel, sharedViewModel)
                }
            }
        )
    }
...
@Composable
fun BodyP41Nosf(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
    ...
    LazyColumn(
        ...
        item {
            ...
            Text(stringResource(R.string.p41TextN),
                color = Color.White)
            ...
            DefaultButton(onClick = {
                ...
                navController.navigate(route = Screens.P51Nosf.route) // 5.1
            },
                text = ("Continuar")
            )
