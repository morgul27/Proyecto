...
fun P51Br(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
        ...
        MaterialTheme(
            ...
            content = {
                ...
                Scaffold (
                    ...
                    //Menu con texto
                    BodyP51Br(navController, viewModel, sharedViewModel)
                }
            }
        )
    }
...
@Composable
fun BodyP51Br(navController: NavController, viewModel: MPViewModel, sharedViewModel: SharedViewModel){
    val state = viewModel.state
    ...
    LazyColumn(
        ...
        item {
            Text(text = stringResource(R.string.p51TextB),
                color = Blanco
            )
